# Generated by Django 4.1 on 2022-09-24 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(max_length=1, verbose_name='Gender')),
                ('isactive', models.BooleanField(default=True)),
                ('typedocument', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='typedocclientowner', to='api.typedocument')),
            ],
            options={
                'ordering': ['id'],
            },
